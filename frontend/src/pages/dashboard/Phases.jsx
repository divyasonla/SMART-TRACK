                ...
                <div className="p-5 flex flex-col flex-1 relative z-10">
                  ...
                  <div className="mt-auto pt-3">
                    {phase.status === 'Locked' ? (
                      ...
                      <Button variant="outline" fullWidth onClick={() => navigate('/workspace')} className="text-xs py-2 border-emerald-300 text-emerald-700 hover:bg-emerald-50 hover:border-emerald-400 shadow-sm">
                        Review Phase
                      </Button>
                    ) : (
                      <Button 
